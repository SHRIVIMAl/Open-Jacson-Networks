...
## Experiment:
![5d136a17-7142-4fe2-9e2b-426d8bd2984a](https://github.com/user-attachments/assets/16834340-f44b-412a-94bb-ff5a135ae464)


## Program
```
Bharr_time=float(input("Enter the mean inter arrival time of objects from Feeder (in
secs): "))
